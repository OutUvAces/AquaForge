...
from vessel_detection.kelvin import G, KNOTS_PER_MS, wake_analysis
from vessel_detection.raster_rgb import (
    is_raster_file,
...
def save_wake_diagram(
    ...
    *,
    ...
    fig.suptitle("Vessel detection — how the estimate is computed", fontsize=12, y=1.02)
