...
from vessel_detection.aquaforge.inference import AquaForgeSpotResult
...
from vessel_detection.shipstructure_adapter import KeypointResult, keypoints_to_jsonable
...
def run_aquaforge_spot_inference(
    ...
    *,
    ...
    from vessel_detection.yolo_marine_backend import polygon_fullres_to_crop
