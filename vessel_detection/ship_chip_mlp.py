...
Uses sklearn only (no PyTorch required). Complements :mod:`vessel_detection.ship_model` LR baseline.
"""
...
from vessel_detection.chip_cache import (
    chip_npz_path,
...
from vessel_detection.review_schema import fused_weights_from_chip_bundle
...
def train_chip_mlp_joblib(
    ...
    *,
    ...
    if not root.joinpath("vessel_detection").is_dir():
