"""
AquaForge inference — sole vessel detector in this app.

**Public detection APIs** (call these from UI, eval, and scripts):

* :func:`run_aquaforge_tiled_scene_triples` — full-scene tiled overlap + NMS.
* :func:`run_aquaforge_spot_decode` — single-location chip decode to the review overlay dict.

Internal: :class:`AquaForgePredictor`, builders, and NMS helpers support training and caching;
do not use alternate backends for candidates.
"""
